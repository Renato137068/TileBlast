...
| TB-004 | P1 | balance | Fase 14 (Combo Jardim): bot perdeu com moves esgotados | `player-audit-latest.md` L10; amostra L43 LOSS moves=24 left=0 score=1170 | Revisar moves/objetivos (Combo Jardim) | `TB_PLAYER_FROM=13 TB_PLAYER_TO=13 npm run player:audit` | S | todo | — |
| TB-005 | P1 | balance | Fase 16 (Primeiro Gelo): vitória no último movimento (margem zero) | `player-audit-latest.md` L11; amostra L44 WIN moves=26 left=0 | +1–2 moves ou aliviar objetivo de gelo | `TB_PLAYER_FROM=15 TB_PLAYER_TO=15 npm run player:audit` | S | todo | — |
