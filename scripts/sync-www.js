...
const copies = [
  ...
  ['mascot-happy.svg', 'mascot-happy.svg'],
  ['mascot-excited.svg', 'mascot-excited.svg'],
  ['mascot-sad.svg', 'mascot-sad.svg'],
  ['mascot-think.svg', 'mascot-think.svg'],
  ['scene-garden.svg', 'scene-garden.svg'],
  ['scene-forest.svg', 'scene-forest.svg'],
  ['scene-mountain.svg', 'scene-mountain.svg'],
  ['scene-ocean.svg', 'scene-ocean.svg'],
  ['scene-inferno.svg', 'scene-inferno.svg'],
  ['scene-crystal.svg', 'scene-crystal.svg'],
  ['scene-legendary.svg', 'scene-legendary.svg'],
